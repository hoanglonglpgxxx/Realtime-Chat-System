    ...
    try {
        ...
        try {
            ...
            if (body.signature && body.nonce && body.eventTime) {
                console.log('\n[FRONTEND] Request already has HMAC fields - FORWARDING AS-IS');
                ...
                console.log('\n[FRONTEND] HMAC_SECRET_KEY not configured');
                console.log('[FRONTEND] Sending request WITHOUT HMAC protection\n');
            }
        } catch (hmacError) {
            console.error('\n[FRONTEND] HMAC generation failed:', hmacError.message);
            console.log('[FRONTEND] Continuing without HMAC...\n');
        }
